...
- Clone this repo with `git clone https://github.com/h4mg/hgd-kruna` or download the zip.
...
- Sasy starter: Developed by [@MinaMarkham](http://twitter.com/MinaMarkham). Please list all bugs and feature requests in the Github issue tracker.
